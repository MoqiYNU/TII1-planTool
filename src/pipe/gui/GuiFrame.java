...
public class GuiFrame
   ...
   private void buildMenus() {
      ...
      //重新命名当前的Tab
      addMenuItem(fileMenu, renameAction  =
    				new FileAction("Rename", "Rename the current tab", ""));
  	...
  	public void rename() {
  	   ...
  	   if (name == null) {//1.不能为空
  	        ...
  	        if (!RenameUtils.isDuplicatedTabName(name)) {
  				...
  				JOptionPane.showMessageDialog(this, "Rename is duplicated!", "Duplicated input", JOptionPane.WARNING_MESSAGE);
  			}
  		}
  	}
