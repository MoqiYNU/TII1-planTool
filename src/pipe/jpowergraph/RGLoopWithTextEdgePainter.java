...
/**
 * This class defines the edge painter for edges with text used in LTS.
 * @author Moqi
 */
public class RGLoopWithTextEdgePainter <T extends LoopEdge> 
    ...
    */   
   public RGLoopWithTextEdgePainter(JPowerGraphColor dragging, 
   ...
   public void paintEdge(JGraphPane graphPane, JPowerGraphGraphics g, T edge, 
      ...
      String text = "" ;
      if (edge instanceof RGLoopWithTextEdge) {
         text = ((RGLoopWithTextEdge)edge).getText();
      }
